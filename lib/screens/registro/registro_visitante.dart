...
class _registroVisitanteState extends State<registroVisitante> {
  ...
  late textFormField apellidos = textFormField("Apellidos", "Ingrese tu apellido(s)",
      "", Icons.account_circle,1,50);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text("Registro Visitante", style: TextStyle(color: Theme.of(context).primaryColorLight),),
          centerTitle: true,
      ...
      body: ListView(
          ...
          children: <Widget>[
            Container(
                ...
                width: 130,
                height: 100,
                child: Icon(Icons.rocket_launch,color: Theme.of(context).primaryColorLight, size: 100,)
            ),
            Container(
